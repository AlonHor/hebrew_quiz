...
"icon.png" type="image/x-icon">
  ...
  <body><br><br><br><center>
    <form action="chips_a.php" method="POST">
    <h1 class="title">איך אומרים "צ'יפס" בעברית?</h1><br><br><br><h2><label>
    מקל תפוח-אדמה </label><input type="text" name="name1" autocomplete="off"></input><br><br><label>
    מילחים </label><input type="text" name="name2" autocomplete="off"></input><br><br><label>
    טוגנים </label><input type="text" name="name3" autocomplete="off"></input><br><br><label>
