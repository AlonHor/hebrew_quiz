...
"icon.png" type="image/x-icon">
  ...
  <body><br><br><br><center>
    <form action="accordion_a.php" method="POST">
    <h1 class="title">איך אומרים "אקורדיון" בעברית?</h1><br><br><br><h2><label>
    ניפוחון </label><input type="text" name="name1" autocomplete="off"></input><br><br><label>
    כריצליל </label><input type="text" name="name2" autocomplete="off"></input><br><label><br><br>
    מפוחון </label><input type="text" name="name3" autocomplete="off"></input><br><br><label>
