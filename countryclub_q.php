...
"icon.png" type="image/x-icon">
  ...
  <body><br><br><br><center>
    <form action="countryclub_a.php" method="POST">
    <h1 class="title">איך אומרים "קאנטרי קלאב" בעברית?</h1><br><br><br><h2><label>
    מועדון שדה </label><input type="text" name="name1" autocomplete="off"></input><br><label><br><br>
    חדר חברה </label><input type="text" name="name2" autocomplete="off"></input><br><label><br><br>
    מועדון בריכה </label><input type="text" name="name3" autocomplete="off"></input><br><label><br><br>
