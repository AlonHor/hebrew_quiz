...
"icon.png" type="image/x-icon">
  ...
  <body><br><br><br><center>
    <form action="magazine_a.php" method="POST">
    <h1 class="title">איך אומרים "מגזין" בעברית?</h1><br><br><br><h2><label>
    מייצגון </label><input type="text" name="name1" autocomplete="off"></input><br><br><label>
    תקופון </label><input type="text" name="name2" autocomplete="off"></input><br><br><label>
    עלילון </label><input type="text" name="name3" autocomplete="off"></input><br><br><label>
