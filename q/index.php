<html dir="rtl">
  ...
  <body><br><center>
    ...
    <h1 class="title">איך אומרים "<?php echo $_POST['question'] ?>" בעברית?</h1><br><h2><label class="o">
    <?php echo $_POST['option1'] ?> </label><input type="text" name="name1" autocomplete="off"></input><br><br><label class="o">
    <?php echo $_POST['option2'] ?> </label><input type="text" name="name2" autocomplete="off"></input><br><br><label class="o">
    <?php echo $_POST['option3'] ?> </label><input type="text" name="name3" autocomplete="off"></input><br><br><label class="o">
