<html dir="rtl">
  ...
  <body><br><br><br><center>
    <form action="schnitzel_a.php" method="POST">
    <h1 class="title">איך אומרים "שניצל" בעברית?</h1><br><br><br><h2><label>
    פרירה </label><input type="text" name="name1" autocomplete="off"></input><br><br><label>
    כתיתה </label><input type="text" name="name2" autocomplete="off"></input><br><br><label>
    שמנון </label><input type="text" name="name3" autocomplete="off"></input><br><br><label>
