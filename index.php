...
"icon.png" type="image/x-icon">
  ...
  <body>
    ...
    ?>
    <center>
      <form action="/q" method="POST" name="start">
        ...
        <input type="text" name="name3perm" autocomplete="off"></input><br><br>
        <input type="text" name="name4perm" autocomplete="off"> </input><br><br><br>
