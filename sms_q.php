...
"icon.png" type="image/x-icon">
  ...
  <body><br><br><br><center>
    <form action="sms_a.php" method="POST">
    <h1 class="title">איך אומרים "אס אמ אס" בעברית?</h1><br><br><br><h2><label>
    מסרר </label><input type="text" name="name1" autocomplete="off"></input><br><br><label>
    מסרון </label><input type="text" name="name2" autocomplete="off"></input><br><br><label>
    הודעה </label><input type="text" name="name3" autocomplete="off"></input><br><br><label>
