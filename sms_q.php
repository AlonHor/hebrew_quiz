...
"icon.png" type="image/x-icon">
  ...
  <body><br><br><br><center>
    <form action="sms_a.php" method="GET">
    <h1 class="title">איך אומרים "אס אמ אס" בעברית?</h1><br><br><br><h2><label>
    מסרר <input type="text" name="name1" autocomplete="off"></input><br><br><label>
    מסרון <input type="text" name="name2" autocomplete="off"></input><br><br><label>
    הודעה <input type="text" name="name3" autocomplete="off"></input><br><br><label>
    אין תחליף <input type="text" name="name4" autocomplete="off"> </input><br><br><br>
